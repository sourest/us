...
import chineseKnot from '../assets/chinese-knot.svg'

console.log(chineseKnot)
...
const MenuList = styled.div<MenuListProps>({
  ...
  bottom: 0,
  right: 0,
  transform: (props: MenuListProps) => `translate3d(0,${props.moveY}px,0)`,
})

const PullingRope = styled.svg({
  position: 'absolute',
  top: '100%',
  right: 20,
  // width: 120,
